...
//+kubebuilder:webhook:path=/mutate-example-com-example-com-v1beta1-app,mutating=true,failurePolicy=fail,sideEffects=None,groups=example.com.example.com,resources=apps,verbs=create;update,versions=v1beta1,name=mapp.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-example-com-example-com-v1beta1-app,mutating=false,failurePolicy=fail,sideEffects=None,groups=example.com.example.com,resources=apps,verbs=create;update,versions=v1beta1,name=vapp.kb.io,admissionReviewVersions=v1
